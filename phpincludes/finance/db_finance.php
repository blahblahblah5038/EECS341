...
class db_finance
{
	...
	public function lineItemFields($lineItem, &$names, &$defValue)
	{
		...
		{	/******************************************************
			...
			case "SC_E_dues":
				$names		=	array(0 => "LINE_ITEM", "Total", "Name", "Cost");
				$defValue	=	array(0 => "Affiliation Dues", "100", "Default Name", "100");
				break;
			case "Donations":
			case "SC_I_donate":
				$names		=	array(0 => "LINE_ITEM", "Total", "Anticipated Donations");
				$defValue	=	array(0 => "Donations", "0", "Default Name");
				break;
			case "Entry Fees":
			case "SC_E_fees":
				$names		=	array(0 => "LINE_ITEM", "Total", "Where", "When", "Number of Teams", "Cost per Team", "Event Title");
				$defValue	=	array(0 => "Entry Fees", "0", "Default Location", "Default Date", "Default Number", "Default Cost per Team", "Default Title");
				break;
			case "Equipment":
			case "SC_E_equip":
				$names		=	array(0 => "LINE_ITEM", "Total", "Quantity", "Item", "Unit Price");
				$defValue	=	array(0 => "Equipment", "0", "Default Quantity", "Default Item", "Default Unit Price");
				break;
			case "Expense of Money Making Projects":
			case "SC_E_mmp":
				$names		=	array(0 => "LINE_ITEM", "Total", "Date", "Event");
				$defValue	=	array(0 => "Expense of Money Making Projects", "0", "Default Date", "Default Event");
				break;
			case "Facilities":
			case "SC_E_facil":
				$names		=	array(0 => "LINE_ITEM", "Total", "Location", "Date", "Cost");
				$defValue	=	array(0 => "Facilities", "0", "Default Location", "Default Date", "Default Cost");
				break;
			case "Fundraising":
			case "SC_I_fundraise":
				$names		=	array(0 => "LINE_ITEM", "Total", "Date", "Event", "Income");
				$defValue	=	array(0 => "Fundraising", "0", "Default Date", "Default Event", "Default Income");
				break;
			case "Membership Dues":
			case "SC_I_dues":
				$names		=	array(0 => "LINE_ITEM", "Total", "Number of Members(expected)", "Dues");
				$defValue	=	array(0 => "Membership Dues", "0", "Default Number", "Default Amount");
				break;
			case "Miscellaneous":
			case "SC_E_misc":
				$names		=	array(0 => "LINE_ITEM", "Total", "Item", "Cost");
				$defValue	=	array(0 => "Miscellaneous", "0", "Default Item", "Default Cost");
				break;
			case "Office Expenses":
			case "SC_E_office":
				$names		=	array(0 => "LINE_ITEM", "Total", "Item", "Cost");
				$defValue	=	array(0 => "Office Expenses", "0", "Default Item", "Default Cost");
				break;
			case "Officials":
			case "SC_E_officials":
				$names		=	array(0 => "LINE_ITEM", "Total", "Date", "Number of Officials", "Cost per Official");
				$defValue	=	array(0 => "Officials", "0", "Default Date", "Default Number", "Default Cost");
				break;
			case "Other Income":
			case "SC_I_other":
				$names		=	array(0 => "LINE_ITEM", "Total", "Item", "Amount");
				$defValue	=	array(0 => "Other Income", "0", "Default Item", "Default Amount");
				break;
			case "Room/Lodging":
			case "SC_E_room":
				$names		=	array(0 => "LINE_ITEM", "Total", "Where", "When", "Number of Days", "Number of People", "Number of Nights");
				$defValue	=	array(0 => "Room/Lodging", "0", "Default Location", "Default Date", "Default Number", "Default Number", "Default Number");
				break;
			case "SCPC Grant":
			case "SC_I_grant":
				$names		=	array(0 =>	"LINE_ITEM", "Total", "Amount");
				$defValue	=	array(0 => 	"SCPC Grant", "0", "Default Amount");
				break;
			case "Transportation":
			case "SC_E_trans":
				$names		=	array(0 => "LINE_ITEM", "Total", "Where", "When", "Number of People", "Number of Vehicles", "Mileage");
				$defValue	=	array(0 => "Transportation", "0", "Default Location", "Default Date", "Default Number", "Default Number", "Default Mileage");
				break;
			case "Workshops, Clinics, etc.":
			case "SC_E_clinic":
				$names		=	array(0 => "LINE_ITEM", "Total", "Date", "Name", "Cost");
				$defValue	=	array(0 => "Workshops, Clinics, etc.", "0", "Default Date", "Default Name", "Default Cost");
				break;
			...
			case "Automatic":
			case "USG_auto":
				$names		=	array(0 =>	"Item", "Total");
				$defValue	=	array(0 =>	"Automatic", "50.00");
				break;
			case "Beginner Safety Equipment":
			case "USG_bsafe":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"Beginner Safety Equipment", "50.00", "Default Description", "Equipment", "1", "50.00");
				break;
			case "USG Equipment":
			case "USG_equip":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"USG Equipment", "Default Total Cost", "Default Description", "Equipment", "1", "Default Unit Cost");
				break;
			case "Instructor Fees":
			case "USG_fees":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"Instructor Fees", "1320.00", "Professional Instruction for Advanced Archers", "Contracted Services", "2", "660.00");
				break;
			case "Renovation Materials":
			case "USG_renov":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"Renovation Materials", "Default Total Cost", "Default Description", "1", "Default Unit Cost");
				break;
			case "USCA Dues":
			case "USG_USCA":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"USCA Dues", "90.00", "Club Recognition by USCA", "Contracted Services", "1", "90.00");
				break;
			case "Targets for Caskey":
			case "USG_Caskey_tar":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"Caskey Targets", "Default Total Cost", "New Targets: 40cm for Compound and recurve", "Equipment", "Default Quantity", "Default Unit Cost");
				break;
			case "Officials for Caskey":
			case "USG_Caskey_off":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"Caskey Officials", "100.00", "Hire officials to judge Caskey Tournament", "Contracted Services", "2", "50.00");
				break;
			case "Chairs for Caskey":
			case "USG_Caskey_chair":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"Caskey Chair Rental", "95.00", "60 chairs + moving fee", "Equipment", "1", "95.00");
				break;
			case "Targets for States":
			case "USG_State_tar":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"States Targets", "Default Total Cost", "New Targets: 40cm and 60cm for Compound and recurve", "Equipment", "Default Quantity", "Default Unit Cost");
				break;
			case "Officials for States":
			case "USG_State_off":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"States Officials", "200.00", "Officials to judge the tournament for two days (\$50 per day per official)", "2", "100.00");
				break;
			case "Chairs for States":
			case "USG_State_chair":
				$names		=	array(0 =>	"Item", "Total", "Description", "Item Category", "Quantity", "Unit Price");
				$defValue	=	array(0 =>	"States Chair Rental", "110.00", "80 chairs + moving fee", "Equipment", "1", "110.00");
				break;
